...
if(NOT "/home/docker/bind_mount/devel/include " STREQUAL " ")
  set(robotic_deposition_INCLUDE_DIRS "")
  set(_include_dirs "/home/docker/bind_mount/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotic_deposition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/docker/bind_mount/src/robotic_deposition/${idir}'.  ${_report}")
    endif()
