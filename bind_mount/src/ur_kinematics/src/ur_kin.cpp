...
//     double T[16] = {91,82,73,64,55,46,37,28,19,10,11,12,13,14,15,16};
//     for(int i=0;i<4;i++) {
...
// }
//  printed
// 91.000 82.000 73.000 64.000 
// 55.000 46.000 37.000 28.000 
...
// int best_sol(const double* solution_matrix, double* q_guess, double* weights){
//     // This is 8 by 6 solution_matrix initialized with zeros
//     vector<vector<double>> solution_matrix(8, vector<double>(6, 0)) = solution_matrix;
//     // This is the 1 by 6 row vector initialized with zeros
//     vector<double> q_guess(6, 0) = q_guess;
//     // This is the weight vector initialized with zeros
//     vector<double> weights(6, 0) = weights;
//     // Now subtract from each entry of the solution_matrix, square, apply weights
//     for(int i=0; i<solution_matrix.size(); i++){
//         for(int j=0; j<solution_matrix[i].size(); j++){
//             solution_matrix[i][j] -= q_guess[j];
//             solution_matrix[i][j] = pow(solution_matrix[i][j], 2);
//             solution_matrix[i][j] *= weights[j];
//         }
//     }
//     // Get the vector of column-sums. Initialized with zeros.
//     vector<double> columnSums(8, 0);
//     for(int i=0; i<solution_matrix.size(); i++){
//         columnSums[i] = accumulate(solution_matrix[i].begin(), solution_matrix[i].end(), 0);
//     }
//     // Find the argmin
//     int minElementIndex = min_element(columnSums.begin(),columnSums.end()) - columnSums.begin();
